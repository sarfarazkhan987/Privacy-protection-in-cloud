            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        else if (fileItem.getFieldName().equals("attribute")) {
                            attribute = fileItem.getString();
                            System.out.println("File Keyword" + attribute);
                        }
                        else if (fileItem.getFieldName().equals("attribute1")) {
                            attribute1 = fileItem.getString();
                            System.out.println("File Keyword" + attribute1);
                        }
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into upload (file,filetype, filename, CDate, data,email,attribute,attribute1,file_key)values(?,?,?,?,?,?,?,?,?)");
                           ...
                           KeyGenerator keyGen = KeyGenerator.getInstance("AES");
                               ...
                               pstm.setString(2, b);
                                ...
                                pstm.setString(6, a);
                                pstm.setString(7, attribute);
                                pstm.setString(8, attribute1);
                                pstm.setString(9, skey);
                                
                                /*Cloud Start*/
                                File f = new File("C:\\Users\\sarfa\\OneDrive\\Desktop\\Upload\\"+fileItem.getName());
