	...
	<div id="container">
 	<div id="banner-fade">
      ...
      <!-- end Basic jQuery Slider -->
                            ...
                            <br>
      <center><p><font size="6" color="black">PSD Registration</font></p></center>
    <form  action="psdregact.jsp" method="post">
    <center>
<table align="center">
       ...
       <tr>
           ...
           <tr>
            ...
            <td><strong><font size="3" color="black">Type</font></strong></td>
                            <td><select class="textbox"  name="type" required="">
           ...
           <tr>
               <td>
            <td><strong><font size="3" color="black">Group</font></strong></td>
                            <td><select class="textbox"  name="group" required="">
