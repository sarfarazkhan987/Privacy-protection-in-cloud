	...
	<div class="nav"> 
 	<ul>
 		...
 		<li><a href="viewuploadedfiles.jsp">Send Keys</a></li>
                ...
                <li class="active"><a href="viewrequests1.jsp">Requests(Write) </a></li>
...
<%
 ...
 ResultSet rs=st.executeQuery("select * from writerequest where status = 'Waiting' and owner = '"+email+"'");
...
<%
   ...
   while(rs.next()){
            ...
            %><tr>
               ...
               <td><a href="writeresponse.jsp?fname=<%=rs.getString("file_name")%>&mail=<%=rs.getString("user")%>">Send to CSP</a> </td>
                <td><a href="rejectresponse1.jsp?fname=<%=rs.getString("file_name")%>&mail=<%=rs.getString("user")%>">Reject</a> </td>
        </tr>
