...
<br>
<center><p><font size="6" color="black">CSP Login</font></p></center>

                    <form action="cspact.jsp" method="post" id="cspact" >
                        <br><br>
                        <center>
                            ...
                            <table>
                                <tr>
                                    <td align="right"><font size="4" color="black"> User Name: </font></td><td> <input type="text" align="left" size="25" name="username" placeholder="UserName" required /></td>
                                </tr>
                                <tr></tr> <tr></tr> <tr></tr>
                                ...
                                <tr>
                                    <td>
                                        <font size="3" color="green"><br> <input type="submit" form="cspact" align="right" value='Submit' />
                                    </td>
