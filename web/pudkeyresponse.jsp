...
<div class="wrap">
	<div class="nav"> 
 	<ul>
 		<li class="active"><a href="pud.jsp">Home</a></li>
 		<li><a href="pudviewfiles.jsp">HAME</a></li>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    String fname = request.getParameter("fname");
     ...
     {
     out.println("<center><body bgcolor='skyblue'> <font size='6'>  To access This file Get Request from Owner<br><br><a href='pudviewresponse.jsp'>Back</a></font>");
     }
     else {
     Connection con;
        Statement st;
