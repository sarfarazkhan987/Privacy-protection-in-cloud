	...
	<div id="container">
 	<div id="banner-fade">
      ...
      <!-- end Basic jQuery Slider -->
                            ...
                            <br>
      <center><p><font size="6" color="black">PUD Registration</font></p></center>
    <form  action="pudregact.jsp" method="post">
    <center>
<table align="center">
       ...
       <tr>
        ...
        <tr>
              <td>
                <td><strong><font size="3" color="black">Doctor ID : </font></strong></td>
               <td><input type="text" name="attribute" id="attribute1" placeholder= Attribute required style="height:30px; width:200px"></input></td> 
              </td>
        </tr>
        <tr>
              <td>
                <td><strong><font size="3" color="black">Medical Researcher ID : </font></strong></td>
               <td><input type="text" name="attribute1" id="attribute1" placeholder= Attribute1 required style="height:30px; width:200px"></input></td> 
              </td>
        </tr>
            ...
            <tr>
              ...
              <td>
                  ...
                  <td><br><input type="submit" value="Register" style="height:30px; width:60px" />
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
