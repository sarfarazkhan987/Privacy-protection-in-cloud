...
<br>
<center><p><font size="6" color="black">Owner Login</font></p></center>

                    <form action="owneract.jsp" method="post" id="owneract" >
                        <br><br>
                        <center>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <font size="3" color="green"><br> <input type="submit" form="owneract" align="right" value='Submit' />
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <td><center><a href="ownerreg.jsp"><br> New User?</a></td>
                                    </td>
                                </tr>
